				...
				>
					<a
						...
						class="min-w-fit p-1.5 {['/playground', '/playground/'].includes($page.url.pathname)
							? ''
							: 'text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:hover:text-white'} transition select-none"
					...
					<!-- <a
						class="min-w-fit p-1.5 {$page.url.pathname.includes('/playground/notes')
							? ''
							: 'text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:hover:text-white'} transition"
